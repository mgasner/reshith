...
export function GreekConjugationExercisePage() {
  ...
  const { data, loading, refetch } = useQuery(GET_GREEK_CONJUGATION_EXERCISES, {
    variables: { count: 10, maxLesson, variant: 'ANCIENT' },
  ...
  return (
    <div className="px-4 max-w-2xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Greek Verb Conjugation</h1>
