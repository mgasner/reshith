...
const EXERCISE_TYPES = [
  {
    path: '/exercises/ecclesiastical-latin/declension',
    title: 'Noun Declension',
    description: 'Practice 1st and 2nd declension noun forms across all five cases.',
    tag: 'Ecclesiastical Latin forms',
  },
  {
    path: '/exercises/ecclesiastical-latin/conjugation',
...
export function EcclesiasticalLatinExercisesPage() {
  return (
    <div className="px-4">
      <div className="mb-8">
        <Link to="/ecclesiastical-latin" className="text-sm text-blue-600 hover:underline mb-2 block">
          ← Ecclesiastical Latin
        </Link>
        <h1 className="text-2xl font-bold text-gray-900">Ecclesiastical Latin Exercises</h1>
