...
export function NTGreekExercisesPage() {
  return (
    <div className="px-4">
      <div className="mb-8">
        <Link to="/nt-greek" className="text-sm text-blue-600 hover:underline mb-2 inline-block">
          &larr; New Testament Greek
        </Link>
        <h1 className="text-2xl font-bold text-gray-900">NT Greek Exercises</h1>
