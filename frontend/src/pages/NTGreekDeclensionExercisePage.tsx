...
import {
  GET_GREEK_DECLENSION_EXERCISES,
...
export function NTGreekDeclensionExercisePage() {
  ...
  const { data, loading, refetch } = useQuery(GET_GREEK_DECLENSION_EXERCISES, {
  ...
  const exercises: Exercise[] = data?.greekDeclensionExercises || []
  ...
  return (
    <div className="px-4 max-w-2xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">NT Greek Noun Declension</h1>
